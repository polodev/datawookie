...
The documentation for StatsBase can be found [here](http://juliastats.github.io/StatsBase.jl/latest/). As the package name implies, it provides support for basic statistical operations in Julia.
